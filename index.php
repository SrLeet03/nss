...
<div class="navbar">
  ...
  <a href="https://nss.gov.in/forms"><i class="search"></i> Search form</a> 
  <a href="#"><i class="envelope"></i> Contact</a> 
  <a href="login.php"><i class="user"></i> Login</a>
  </div>

<h3 align="center" style="background-color:blue ; color:red ;">WELCOME TO NSS IIT ROORKEE PORTAL</h3>
<div class="info">
<p><b>you can register here to join NSS-IITR</b></p>
</div>
